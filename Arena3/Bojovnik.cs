...
namespace Arena3
{
    internal class Bojovnik
    {
        ...
        public Bojovnik(string jmeno)
        {
            ...
            this.jmeno = jmeno;
            zivot = random.Next(90, 121);
            maxZivot = zivot;
            utok = random.Next(18, 28);
            obrana = random.Next(8, 15);
        ...
        public virtual string VypisBorce()
        {
            string zprava = $"Tvůj bojovník {jmeno} má následující vlastnosti: \n{maxZivot} životů \nútok {utok}\nobranu {obrana}\n\n";
            return zprava;
        }
